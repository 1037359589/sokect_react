...
var AddPerson = React.createClass({
    ...
    render: function () {
        ...
        return React.createElement("button", { className: "btn border-red normal hover add", "data-mousedown": "true", id: "add-person" }, "添加成员");
    }
});
...
var ControlButton = React.createClass({
    ...
    render: function () {
        return React.createElement("div", { className: "control", id: "control" }, React.createElement(Clear, { onClick: this.handleClick.bind(this), initialClear: this.state.clear, callbackParent: this.onChildChanged }), React.createElement(AddPerson, null), React.createElement(DeletePerson, null), React.createElement(SendMessage, null));
    }
});
...
var MessageBody = React.createClass({
    ...
    render: function () {
        ...
        return React.createElement("div", { className: "body", id: "message-body" }, "ASAASFAF");
    }
});
...
var Message = React.createClass({
    ...
    render: function () {
        ...
        return React.createElement("div", { className: "message", id: "main" }, React.createElement(MessageBody, { clear: this.state.clear }), React.createElement(MessageInput, null), React.createElement(ControlButton, null));
    }
});
